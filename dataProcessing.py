...
torch.save(le_train_loader, 'LeNetTrainLoader.pt')
torch.save(le_val_loader, "LeNetValLoader.pt")
...
torch.save(alex_train_loader, 'AlexNetTrainLoader.pt')
torch.save(alex_val_loader, "AlexNetValLoader.pt")
